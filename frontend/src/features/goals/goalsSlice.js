  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(createGoal.fulfilled, (state, action) => {
        state.isLoading = false;
        (state.isSuccess = true), state.goals.push(action.payload);
      })
      ...
      .addCase(getGoals.fulfilled, (state, action) => {
        state.isLoading = false;
        (state.isSuccess = true), (state.goals = action.payload);
      })
...
export const { reset, resetErrorState } = goalsSlice.actions;
